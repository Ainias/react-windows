...
const WindowContainer = (0,react_bootstrap_mobile_namespaceObject.withForwardRef)(function WindowContainer({
  ...
  const shouldResizeToContent = (0,external_react_.useRef)(true);
  ...
  const [setActiveContainer, updateContainerDimension, updateContainerState, setContainerButtonWidth, setContainerIsMoving, setContainerIsLocked] = useStore(s => [s.setActiveContainer, s.updateContainerDimension, s.updateContainerState, s.setButtonWidth, s.setContainerIsMoving, s.setContainerIsLocked], shallow);
  ...
  const checkResizeToContent = (0,external_react_.useCallback)(() => {
    if (shouldResizeToContent.current && (windowData === null || windowData === void 0 ? void 0 : windowData.id) !== draggingWindowId) {
      resizeToContent();
    }
  }, [draggingWindowId, resizeToContent, windowData === null || windowData === void 0 ? void 0 : windowData.id]);
