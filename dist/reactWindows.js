...
___CSS_LOADER_EXPORT___.locals = {
	...
	"closeable": "closeable__Mi64S",
	"titleTabActive": "titleTabActive__DLrBx",
	"closeButton": "closeButton__T5Ruv",
...
__webpack_require__.d(__webpack_exports__, {
  ...
  "selectCanCloseContainer": () => (/* reexport */ selectCanCloseContainer),
  ...
  return {
    ...
    closeContainer(containerId) {
      ...
      container.windowIds.forEach(id => {
        var _a, _b;
        (_b = (_a = windows[id]) === null || _a === void 0 ? void 0 : _a.onClose) === null || _b === void 0 ? void 0 : _b.call(_a);
      });
    },
    clearDraggingWindow() {
      set({
...
const plural = () => '';
const selectOrdinal = () => '';
;// CONCATENATED MODULE: ./src/i18n/useT.ts
...
function useT(key) {
  const {
    t: _t,
    i18n
  } = useTranslation_useTranslation(key);
...
const WindowButton = (0,react_bootstrap_mobile_namespaceObject.withMemo)(function WindowButton(_a) {
  ...
  var {
    ...
    listenerProps = __rest(_a, ["icon", "title", "containerState", "hideWhenMaximized", "hideWhenMinimized", "className", "style"]);
  // Refs
  // States
  // Selectors
  // Callbacks
  ...
  return /*#__PURE__*/external_react_.createElement(react_bootstrap_mobile_namespaceObject.Clickable, {
    onClick: onClick,
    className: classnames_default()(className, (windowButton_default()).windowButton),
    style: style
...
const TitleTab = (0,react_bootstrap_mobile_namespaceObject.withMemo)(function TitleTab({
  ...
  const onClose = useStore(s => {
    var _a;
    return (_a = s.windows[id]) === null || _a === void 0 ? void 0 : _a.onClose;
  });
  ...
  return /*#__PURE__*/external_react_default().createElement(react_bootstrap_mobile_namespaceObject.InlineBlock, {
    className: classnames_default()((windowContainer_default()).titleTab, {
      ...
      [(windowContainer_default()).closeable]: !!onClose
    }, className),
    style: style
  ...
  }, children), /*#__PURE__*/external_react_default().createElement(react_bootstrap_mobile_namespaceObject.Clickable, {
    onClick: onClose,
    className: (windowContainer_default()).closeButton
  }, /*#__PURE__*/external_react_default().createElement(react_bootstrap_mobile_namespaceObject.Icon, {
    icon: free_solid_svg_icons_namespaceObject.faClose
  }))));
...
;// CONCATENATED MODULE: ./src/Components/store/selectCanCloseContainer.ts
function selectCanCloseContainer({
  containers,
  windows
}, containerId) {
  const container = containers[containerId];
...
const WindowContainer = (0,react_bootstrap_mobile_namespaceObject.withForwardRef)(function WindowContainer({
  ...
  const isResizing = (0,external_react_.useRef)(false);
  ...
  const [setActiveContainer, updateContainerDimension, updateContainerState, setContainerButtonWidth, setContainerIsMoving, setContainerIsLocked, setShouldResizeToContent, closeContainer] = useStore(s => [s.setActiveContainer, s.updateContainerDimension, s.updateContainerState, s.setButtonWidth, s.setContainerIsMoving, s.setContainerIsLocked, s.setShouldResizeToContent, s.closeContainer], shallow);
  ...
  // Selectors
  // Callbacks
  const setIsMoving = (0,external_react_.useCallback)(newIsMoving => {
  ...
  const checkResizeToContent = (0,external_react_.useCallback)(() => {
    if (shouldResizeToContent !== ResizeToContentEnum.NONE && (windowData === null || windowData === void 0 ? void 0 : windowData.id) !== draggingWindowId && containerData.state === ContainerState.NORMAL) {
  ...
  const realButtons = (0,external_react_.useMemo)(() => {
    ...
    if (containerData.isLocked) {
      newButtons.push({
        ...
        order: 5,
        className: (windowContainer_default()).lockedIcon
      });
    }
